...
#define eslMSAFILE_MATCH       116  /* aligned FASTA format (matched state only)   */
#define eslMSAFILE_FIRST       117  /* aligned FASTA format (matched first sequence)   */
#define eslMSAFILE_AFQ         118  /* aligned FASTA format (first sequence only)  */
